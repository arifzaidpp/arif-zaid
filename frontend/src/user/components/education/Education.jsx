            ...
            <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical py-20  bg-[url('./src/assets/bg.png')]">
                {educationData.map((edu, index) => (
                    <li key={index}>
                        ...
                        {index === 0 ? null : <hr className={edu.completed ? "bg-indigo-500" : "bg-gray-800"} />}
                        <div className="timeline-middle">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                                className={edu.completed ? "text-indigo-500 h-5 w-5" : " h-5 w-5"}>
                                <path
                                    fillRule="evenodd"
                        ...
                        <div className={index % 2 === 0 ? `timeline-start mb-10 md:text-end timeline-box text-gray-300 ${edu.completed ? "bg-blue-500 text-rgb-white" : "bg-gray-800"} shadow-lg border-none ` : `timeline-end timeline-box text-gray-300 ${edu.completed ? "bg-blue-500 text-rgb-white" : "bg-gray-800"} shadow-lg border-none`}>
                        ...
                        {index === educationData.length - 1 ? null : (
                            <hr className={
                                educationData[index + 1].completed ? "bg-indigo-500" : "bg-gray-800"
                            } />
                        )}
                    </li>
                ))}
