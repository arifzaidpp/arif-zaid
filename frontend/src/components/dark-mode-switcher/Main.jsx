...
function Main(props) {
  ...
  return (
    <>
      ...
      <div
        className="dark-mode-switcher cursor-pointer shadow-md bottom-0 right-0 box border rounded-full w-40 h-12 flex items-center justify-center z-50 mb-1 mr-10"
        onClick={switchMode}
      >
